...
/*
- @WebMvcTest는 JPA 기능이 작동하지 않기 때문에 JPA 기능까지 한번테 테스트 할 땐 @SpringBootTest와 TestRestTemplate를 사용하면 된다.

- @WithMockUser(roles="USER")
: 인증된 가짜 사용자를 만들어 사용한다. roles에 권한을 추가할 수 있음 
  -> 이 어노테이션으로 ROLE_USER 권한을 가진 사용자가 API 요청하는 것과 동일한 효과를 가짐
*/
